 ...
 * 서술(특징·장단점·학습 유의사항)은 교사용 매뉴얼(이수증/학습 도장/PC 권장/순차학습)에 근거.
 */
  ...
  return [
    ...
    },
    {
      ...
      bullets: [
        ...
        { h: '즉시 학습·이수증', d: '회원가입 없이 접속, [학습 도장 모으기] 완주 시 이수증 출력' },
      ],
    },
    {
      layout: 'proscons',
      ...
      cons: [
        ...
        '[학습 도장 모으기] 학습 시 영상 재생바 이동 불가 (정배속 순차 학습)',
      ],
    },
    {
      layout: 'lessons',
    ...
    },
    {
      ...
      block: pal.usage,
      bullets: [
        { h: '학습 도장 모으기', d: '학년별 배너 → [학습 도장 모으기]로 진행해야 완주 후 이수증 출력 가능' },
        { h: '끝까지 완주', d: '로그인이 없어 중간 종료 시 처음부터 재학습 — 한 번에 끝까지 진행' },
        { h: '이름 정확히 입력', d: '이수증은 마지막 단계에서 발급 — 이름 확인 후 PDF로도 저장 권장' },
        { h: '기기 권장', d: '상호작용이 많은 콘텐츠 — 데스크톱·노트북·태블릿에서 학습' },
      ],
    },
    {
      layout: 'closing',
